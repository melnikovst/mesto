...
const cardEditor = document.querySelector('.popup__template_edit');
...
const cardEditorInputName = document.querySelector('.popup__template_form_input_type_name');
const cardEditorInputLink = document.querySelector('.popup__template_form_input_type_link');
const cardForm = document.querySelector('.popup__template_form');
