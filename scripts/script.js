...
const cardEditorInputName = document.querySelector('.popup_template_form_input_type_name');
const cardEditorInputLink = document.querySelector('.popup_template_form_input_type_link');
const cardForm = document.querySelector('.form__popup_template');
